## MRRw2pxy.r
## This is a wrapper function intended only for testing the MRRw2pXonY function in the
...
## now sort the dataframe on data values
  ...
  Weibull<-.Call("MRRw2pXonY", data, event, PACKAGE= "pivotals")  
